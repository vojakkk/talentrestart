                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
                    <div className="space-y-2">
                        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-restart/10 text-restart text-xs font-black uppercase tracking-widest">
                            ...
                            Premium Talent Access
                        </div>
                        <h1 className="text-4xl font-black tracking-tight">Athlete <span className="text-muted-foreground/30">/</span> Database</h1>
                        <p className="text-muted-foreground font-medium">Find candidates with the discipline and grit of elite athletes.</p>
                    </div>
                ...
                <div className="relative mb-12 group">
                    ...
                    <div className="relative flex p-2 bg-card border border-border rounded-2.5xl shadow-xl">
                        <div className="flex-1 flex items-center px-4 gap-3">
                            ...
                            <Input
                                placeholder="Search by name, sport or professional skill..."
                ...
                <div className="grid lg:grid-cols-4 gap-8">
                    ...
                    <aside className="space-y-8">
                        <div className="bg-card border border-border rounded-3xl p-6 space-y-6 shadow-sm">
                            <h3 className="font-black text-xs font-mono uppercase tracking-widest text-muted-foreground flex items-center justify-between">
                                Filters
                                <span className="text-[10px] text-restart cursor-pointer hover:underline">Reset</span>
                            </h3>

                            <div className="space-y-6">
                                <div className="space-y-3">
                                    <label className="text-xs font-black uppercase tracking-wider">Sporting Level</label>
                                    {['Professional', 'Olympic', 'National Team', 'Division I'].map(level => (
                                ...
                                <div className="space-y-3">
                                    <label className="text-xs font-black uppercase tracking-wider">Availability</label>
                                    {['Immediate', 'Within 1 month', 'Open to offers'].map(level => (
                                        <div key={level} className="flex items-center gap-3">
                                            <div className="w-4 h-4 rounded border border-border" />
                                            <span className="text-sm font-medium">{level}</span>
                                        </div>
                        ...
                        <div className="bg-gradient-to-br from-gray-900 to-black rounded-3xl p-8 text-white relative overflow-hidden">
                            ...
                            <h4 className="font-bold text-lg leading-tight mb-2">Verified Athletes</h4>
                            <p className="text-xs opacity-60 font-medium leading-relaxed">
                                Every candidate's sports history is verified by our team for authenticity.
                            </p>
                        </div>
                    </aside>
                    ...
                    <div className="lg:col-span-3 space-y-6">
                                ...
                                <div key={athlete.id} className="group bg-card border border-border rounded-[2.5rem] p-8 hover:shadow-2xl hover:shadow-restart/5 transition-all cursor-pointer relative overflow-hidden">
                                    <div className="flex flex-col md:flex-row gap-8">
                                            ...
                                            <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
                                                <div>
                                                    ...
                                                    <div className="flex flex-wrap items-center gap-x-6 gap-y-1 text-sm font-bold text-muted-foreground">
                                                        <div className="flex items-center gap-1.5"><Award className="w-4 h-4 text-restart" /> {athlete.sports_career || "Athlete"}</div>
                                                        <div className="flex items-center gap-1.5"><MapPin className="w-4 h-4" /> Prague, CZ</div>
                                                        <div className="flex items-center gap-1.5"><Star className="w-4 h-4 text-yellow-500 fill-yellow-500" /> Top Talent</div>
                                                    </div>
                                                </div>
                                        ...
                                        <div className="hidden md:flex flex-col items-end justify-center px-4 border-l border-border/50">
                                            <div className="text-[10px] font-black uppercase text-muted-foreground mb-1">Match Score</div>
                        ...
                        <div className="p-12 text-center rounded-[2.5rem] bg-gradient-to-br from-card to-muted border-2 border-dashed border-border group cursor-pointer hover:border-restart transition-colors">
                            ...
                            <h4 className="text-xl font-black mb-2">Upgrade to Unlock 85% More Talent</h4>
                            <p className="text-muted-foreground font-medium text-sm mb-6 max-w-md mx-auto">
                                Your current plan only shows the top performers. Gain access to our full database of 1,500+ candidates.
                            </p>
