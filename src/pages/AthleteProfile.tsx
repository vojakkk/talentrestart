...
const AthleteProfile: React.FC = () => {
    ...
    const runAiAssistance = () => {
        ...
        setTimeout(() => {
            const currentSummary = profileData.summary;
                ...
                <div className="grid lg:grid-cols-12 gap-8">
                    ...
                    <div className="lg:col-span-4 space-y-8">
                        ...
                        <div className="bg-card border border-border rounded-[2.5rem] p-8 shadow-sm">
                            ...
                            <div className="border-2 border-dashed border-border rounded-2xl p-8 text-center hover:border-talent hover:bg-talent/5 transition-all cursor-pointer group">
